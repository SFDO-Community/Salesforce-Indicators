...
export default class IndicatorBuilder extends LightningElement {
    ...
    /* ACTION FUNCTIONS */
    addNewVariant(label, whenToDisplay, isExtension) {
        this.itemVariants.push(this.newIndicatorVariant(label, whenToDisplay, isExtension));
